...
> extends HttpClient<SecurityDataType> {
  api = {
     ...
     *
     * @tags Home
     * @name HomeUsersRecentHotelsList
     ...
     * @secure
     */
    hotelsReviewsList: (hotelId: number, params: RequestParams = {}) =>
